...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
            <h3 class="title_default"><span>PEDIDO DE  PRESUPUESTO</span></h3>
            <div class="form">
                <form>
                    ...
                    <label>Tiene idea del tamaño de cilindro que necesita o cuéntenos cuantos km hace por día en su vehículo</label>
                    <input type="text" name="" id="input" class="form-control" value="" pattern="" title="">
