...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
            <h3 class="title_default"><span>TRABAJÁ CON NOSOTROS</span></h3>
            <div class="form">
                <form>
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-search"></span> Buscar</span>
                    </div>
